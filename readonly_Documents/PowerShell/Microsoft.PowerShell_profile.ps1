...
function set_proxy_variable {
        Set-Item Env:http_proxy "http://127.0.0.1:41091"  # 代理地址
        Set-Item Env:https_proxy "http://127.0.0.1:41091" # 代理地址
}
...
# ReadLineOption -ViModeIndicator Script -ViModeChangeHandler $Function:OnViModeChange
Set-PSReadLineOption -EditMode Emacs
Set-PSReadlineKeyHandler -Key Tab -Function MenuComplete
# oh-my-posh init pwsh --config "$env:POSH_THEMES_PATH\robbyrussell.omp.json" | Invoke-Expression
Invoke-Expression (& { (zoxide init powershell | Out-String) })# powershell completion for chezmoi                              -*- shell-script -*-
...
Set-Alias -Name spp -Value set_proxy_variable
Set-Alias -Name upp -Value unset_proxy_variable
Set-Alias -Name ch -Value chezmoi
Set-Alias -Name ff -Value fastfetch
Register-ArgumentCompleter -CommandName 'ch' -ScriptBlock ${__chezmoiCompleterBlock}
